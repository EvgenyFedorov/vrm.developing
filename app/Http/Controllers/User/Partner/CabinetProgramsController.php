...
class CabinetProgramsController extends UserController
{
    public $request = null;
    public $user = null;
    ...
    public function index()
    {
        ...
        if($result = $this->isRole()){
            ...
            $data_programs = $this->programs()->getPaginate();

            return view($result['role']['dir'] . '.programs.list', [
                'user' => $result['user'],
                'role' => $result['role'],
    ...
    public function create()
    {
        if($result = $this->isRole()){
            ...
            return view($result['role']['dir'] . '.programs.create', [
                'user' => $result['user'],
                'role' => $result['role'],
    ...
    public function edit($id)
    {
        if($result = $this->isRole()){
            ...
            return view($result['role']['dir'] . '.programs.edit', [
                'user' => $result['user'],
                'role' => $result['role'],
                'data_users' => $data_users,
                'program' => $program,
